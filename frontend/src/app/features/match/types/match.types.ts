...
export type MatchStatus = 'not_started' | 'in_progress' | 'finished' | 'cancelled';
...
export const MATCH_FILTERS: readonly MatchFilter[] = ['all', 'not_started', 'in_progress', 'finished', 'cancelled'] as const;
