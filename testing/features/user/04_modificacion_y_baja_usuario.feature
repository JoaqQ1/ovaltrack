...
Característica: Modificación o baja de rol de usuario
  ...
  Escenario: Un usuario dado de baja no puede iniciar sesión
    ...
    Entonces el sistema rechaza el inicio de sesión indicando "El usuario se encuentra dado de baja"
  ...
  Escenario: El administrador de club no puede darse de baja a sí mismo
    ...
    Entonces el sistema rechaza la baja con el mensaje "No puede darse de baja mientras sea el administrador designado de un club"
  ...
  Escenario: Intentar dar de baja a un usuario que ya está inactivo
    ...
    Cuando solicita dar de baja al usuario con email "jugador.tres@test.com"
    Entonces el sistema rechaza la baja con el mensaje "El usuario ya se encuentra dado de baja"
  ...
  Escenario: No se puede modificar el rol de un usuario dado de baja
    ...
    Entonces el sistema rechaza la acción indicando "No se puede modificar el rol de un usuario dado de baja"
  ...
  Escenario: El administrador de club no puede dar de baja a otro administrador
    ...
    Entonces el sistema rechaza la baja con el mensaje "No tiene permisos para dar de baja a otro administrador"
